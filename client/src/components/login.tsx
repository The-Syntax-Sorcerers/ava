...
export default function LoginForm({ setShowModal }) {
    ...
    return (
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-shadow bg-opacity-25">
            <div className="relative w-1/3 p-6 container bg-main rounded shadow-2xl">
