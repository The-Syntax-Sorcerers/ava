...
export default function SubjectCard({ sub, rkey }: { sub: any, rkey: Key }) {
    return (
        <a href={sub.link}>
        <div key={rkey} className="bg-neutral-50 hover:bg-neutral-100 rounded-lg shadow-md p-4 transform hover:scale-105 transition-transform duration-300 cursor-pointer border-2 border-card-border">
