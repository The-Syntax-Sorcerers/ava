...
export default function AssignmentCard({ ass, inSubject }: { ass: any, inSubject: boolean }) {
    ...
    return (
        <a href={ass.link}>
        <div className="bg-neutral-50 hover:bg-neutral-100 rounded-lg shadow-md p-4 transform hover:scale-105 transition-transform duration-300 cursor-pointer border-2 border-card-border">
