...
def privacy_policy(loginform=None, signupform=None):
    ...
    if flask_login.current_user.is_authenticated:
        ...
        return flask.render_template('routePrivacyPolicy/index.html',
                                     auth_user=True, template_data=json.dumps(template_data),
                                     csrf=flask_wtf.csrf.generate_csrf())
    else:
        print("Serving Anonymous Privacy Policy")
        return flask.render_template('routePrivacyPolicy/index.html',
                                     auth_user=False, template_data=json.dumps(template_data),
                                     csrf=flask_wtf.csrf.generate_csrf())
...
def subject():
    ...
    template_data = {
        ...
        "subject": {"id": "BSBS873295", "name": "Intro to BS",
                    "description": ("Bullshit is everywhere, and we've had enough. "
                                    "We want to teach people to detect and defuse bullshit where ever it may arise."),
...
def assignment():
    ...
    template_data = {
        "assignment": {"due_date": "12/31/2023", "id": "BSBS873295",
                       ...
                       "link": "/assignment",
                       "description":
                       "Write stuff in your own words. Do not use ChatGPT or any AI to assist you. WE CAN TELL!!",
                       "marks": "???/100"},
        "user_type": "student"
    }
